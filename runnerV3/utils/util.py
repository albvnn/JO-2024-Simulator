...
class Utils():
    ...
    def __init__(self):
        ...
        self.font8 = pygame.font.Font('runnerV3/assets/Unicorn.ttf', 8)
        self.font12 = pygame.font.Font('runnerV3/assets/Unicorn.ttf', 12)
        self.font16 = pygame.font.Font('runnerV3/assets/Unicorn.ttf', 16)
        self.font24 = pygame.font.Font('runnerV3/assets/Unicorn.ttf', 24)
        self.font32 = pygame.font.Font('runnerV3/assets/Unicorn.ttf', 32)
        self.font48 = pygame.font.Font('runnerV3/assets/Unicorn.ttf', 48)
    ...
    def showFps(self):
        ...
        if self.fps >= 50:
            self.drawText(Vector2(0, 0), "fps: " + str(self.fps + 880), (23, 233, 23), self.font16)
        else:
            self.drawText(Vector2(0, 0), "fps: " + str(self.fps + 880), (233, 23, 23), self.font16)
